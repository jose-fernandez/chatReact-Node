  ...
  render: function () {
    return (
      React.createElement("div", {className: "chat-box"},
        React.createElement("h1", {className: "title"}, "ChatBucks",
        React.createElement("img",{src:"images/react.png"}),
        React.createElement("img",{src:"images/node.png"})
        ),
  ...
  render: function () {
    return (
      React.createElement("form", {className: "chat-form", onSubmit: this.handleSubmit}, 
        React.createElement("input", {className: "input body-input", type: "text", placeholder: "Write a message here...", ref: "body"}), 
